...
L.Polyline.include({
    ...
    _snakeForward: function (forward) {
        ...
        // console.trace('Distance to next point:', distance, '; Now at: ', this._snakingDistance, '; Must travel forward:', forward);
        // console.trace('Vertices: ', this._latlngs);
...
L.Polyline.mergeOptions({
    snakingSpeed: 400 // In pixels/sec
});
...
L.LayerGroup.include({
    ...
    _snakeNext: function () {
        ...
        if ('snakeIn' in currentLayer) {
            currentLayer.once('snake_end', function () {
