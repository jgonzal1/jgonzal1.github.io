  ...
  render() {
    ...
    if (this.state.mondayTasksByCategorySvg.length) { // Add Donut Chart
      ...
      goalsDom.innerHTML = `<table>
        ...
        <tr><td>🍏/Health</td>    <td id="healthCount" class="bold-right">4</td>    <td>
          <span style="color:#caa04c">🩺checks</span> <span style="color:#e15759">🪁🏄ks</span></td>
        </tr>
        <tr><td>🏠💰/FIRE</td>    <td id="fireCount" class="bold-right">3</td>    <td id="fireGoal"><div class="bordered" style="color:#e15759">🏠♴💼</div></td></tr>
