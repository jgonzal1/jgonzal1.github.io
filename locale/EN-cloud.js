  ...
  */
  ...
  <tr>
    ...
    <td colspan="2" class="w70">
      I am an AWS and Azure cloud consultant experienced in DevOps, CI/CD, software development and architecture, data engineering and
      BI.
    </td>
  </tr>
  <tr>
...
<tr>
    ...
    <td class="w70">
      ...
      <p>Roles:</p>
      <p>Architectural design, best practices, design of cloud architecture, IaC, CI/CD.</p>
      <p>Cloud consultant, DevOps consultant, full-stack developer, data engineer, and AWS/JSM/Power BI/monday.com technical consultant.
      <br><br></p>
      ...
      <li>Architectural design, best practices, design of cloud architecture, IaC, CI/CD.</li>
      ...
      <li>Creation of a web-service for Dr. Oetker internal stakeholders for enabling them to modify nginx configuration for different Dr. Oetker websites.<br></li>
      <li>Azure Storage (SQL), Azure App Service</li></ol>
      ...
      </span> on the resolution for <span class="arch">all the Service Desk incidences</span> for this App.</p>
      <p>Architectural design, best practices, design of cloud architecture, IaC, CI/CD.<br><br></p>
  ...
  <tr>
    ...
    <td class="w70">
      ...
      <p>Roles:</p>
      <p>Architectural design, best practices, design of cloud architecture, IaC, CI/CD.</p>
      <p>Full-stack developer, consultant, and Power BI technician.</p>
      <p>Azure Storage (SQL), Azure App Service<br><br></p>
      ...
      "cloud Kubernetes">setting up Docker containers for all the components in Docker containers on a Kubernetes cluster</span> for a big Smart City project.</p>
      <p>Architectural design, best practices, design of cloud architecture, IaC, CI/CD.<br><br></p>
  ...
  <tr>
    ...
    <td class="w70">
      ...
      <p>Azure Storage (SQL), Azure App Service</p>
      <p>Architectural design, best practices, design of cloud architecture, IaC, CI/CD.<br><br></p>
      ...
      Involving data extraction from both an Oracle database and Google Sheets</span> spreadsheets, transformation of data in Azure Storage solutions (with
      <span class="bi">Data Lake Analytics and Azure App Service within Azure Data Factory</span>, and load of data in <span class="bi">Data Lake Storage
      CSVs which are taken by Power BI for its <span class='webdev'>data representation</span></span>).<br><br></p>
  ...
  <tr>
    ...
    <p><span class='webdev'>Software development in C# to build chat-bots</span>. Enabling connections with IBM Watson and Microsoft LUIS technologies.</p>
    <p>Architectural design, best practices, design of cloud architecture, IaC, CI/CD.<br><br></p>
    </td>
  </tr>
  <tr class="no-border">
