function getSpanishContents() {
  ...
  <tr>
    ...
    <td colspan="2" class="w70">
      <span class="highlight-orange">AWS EC2</span>, <span class="highlight-orange">Amazon Code Commit</span> (git), <span class="bi highlight-orange">Amazon Redshift</span> (SQL), <span class="bi highlight-orange">AWS Glue</span> (pyspark), <span class="highlight-blue">Excel</span> (avanzado), <span class="bi highlight-yellow">Power BI</span> (funciones DAX, R), <span class="highlight-red">Python</span> (boto3, <span class="bi">pyspark</span>, numpy, pandas, scikit-learn...), <span class="webdev highlight-red">JavaScript</span> (experiencia en desarrollo <i>full stack</i> con React, Angular, jQuery, Leaflet, BootStrap, D3.JS, Ionic, Node.JS, Three.JS, ESLint y TypeScript), <span class="webdev highlight-red">CSS</span> (BootStrap, LeafLet, AwesomeFonts), <span class="webdev highlight-red">HTML</span> (estructuras complejas y manejadores DOM), <span class="highlight-red">Docker</span>, <span class="highlight-red">Terraform</span>, <span class="webdev highlight-red">Expresiones regulares</span> (avanzado), <span class="bi highlight-blue">Azure Data Lake Analytics</span> (<span class="bi">U-SQL</span>, C#), <span class="bi highlight-blue">Azure Data Factory</span> (ETLs), <span class="highlight-gray">IBM Watson</span> (soluciones de IA), <span class="webdev highlight-blue">Azure App Service</span>, <span class="highlight-blue">Microsoft LUIS</span>.
    </td>
  </tr>
  <tr>
    <td colspan="3">
  ...
  <tr>
    ...
    <td colspan="2" class="w70"><br>(Nov 21 - Actualidad)<br>Desarrollador de Software
    </td>
  </tr>
  <tr>
    <td colspan="3"><br></td>
  ...
  <tr>
    ...
    <td colspan="2" class="w70"><br>(Nov 19 - Nov 21)<br>Desarrollador y consultor de software, técnico en Power BI</td>
  </tr>
  <tr>
    <td colspan="3"><br></td>
  </tr>
  ...
  <tr>
    <td class="bold-right"> </td>
    <td colspan="2" class="w70">
      Dic 20 - Nov 21<br>Technical consultant for <span class='webdev'>full-stack development</span> on <span class='bi webdev cloud'>Pentaho CDE</span> reports for a Smart City<br>Technical consultant whose role was to implement proofs of concept for full-stack
  ...
  <tr>
    <td class="bold-right"> </td>
    <td colspan="2" class="w70">Dic 20 - May 21<br><span class="bi">Consultor técnico de Power BI</span><br>
  ...
  <tr>
    <td class="bold-right"> </td>
    <td colspan="2" class="w70">Oct 20 - Dic 20<br><span class="bi">Consultor técnico de Power BI</span><br>
  ...
  <tr>
    <td class="bold-right"> </td>
    <td colspan="2" class="w70">Sep 20 - Oct 20<br>Desarrollador y consultor de <i>software</i><br>
  ...
  <tr>
    <td class="bold-right"> </td>
    <td colspan="2" class="w70">Jun 20 - Sep 20<br><span class="bi">Consultor y técnico de Power BI</span><br>
  ...
  <tr>
    <td class="bold-right"> </td>
    <td colspan="2" class="w70">May 20 - Jun 20<br>Desarrollador y consultor de <i>software</i><br>
    Desarrollador y consultor de <i>software</i> para implementar un traductor automático multi-idioma para una administración pública autonómica
    </td>
  </tr>
  <tr>
  ...
  <tr>
    <td class="bold-right"> </td>
    <td colspan="2" class="w70">Mar 20 - Abr 20<br><span class="bi">Técnico de <i>Big Data</i></span><br>Técnico de Big Data en la implementación de un entorno de científicos de datos para la mayor empresa aseguradora de España, mediante el uso de tecnologías <i>cloud</i> con <span class="bi">Python, AWS Lambda, AWS Step Functions, AWS S3, AWS Athena</span> y AWS IAM.
    </td>
  </tr>
  <tr>
    <td colspan="3"><br></td>
  ...
  <tr>
    <td class="bold-right"> </td>
    <td colspan="2" class="w70">Dic 19 - Ene 20<br><span class='webdev'>Desarrollador full-stack de un chatbot</span><br>Desarrollo full-stack de un chatbot desde cero para un <span class='webdev'><i>front-end</i> web sin servidor</span> usando llamadas <span class='webdev'>AJAX</span> a Microsoft L.U.I.S.,
  ...
  <tr>
    <td class="bold-right"> </td>
    <td colspan="2" class="w70">Nov 19 - Dic 19<br>Consultor técnico de Azure y Power BI<br>Desarrollador de <span class="bi"><span class='webdev'>cuadros de mando</span> en Power BI y sus ETLs</span> para un entorno de monitorización de Azure Log Analytics para una gran empresa inmobiliaria.
    </td>
  </tr>
  <tr>
    <td colspan="3"><br></td>
  ...
  <tr>
    ...
    <td colspan="2" class="w70">(Colaboración, Oct 21)<br>
